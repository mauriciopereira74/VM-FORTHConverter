...
_lr_productions = [
  ...
  ('char_expression -> CHAR CHARACTER','char_expression',2,'p_char_expression','parserr.py',35),
  ('statement -> WORD','statement',1,'p_statement_word','parserr.py',41),
  ('statement -> PLUS','statement',1,'p_statement_operator','parserr.py',51),
  ('statement -> MINUS','statement',1,'p_statement_operator','parserr.py',52),
  ('statement -> TIMES','statement',1,'p_statement_operator','parserr.py',53),
  ('statement -> DIVIDE','statement',1,'p_statement_operator','parserr.py',54),
  ('statement -> DOT','statement',1,'p_statement_output','parserr.py',60),
]
